DEVELOPER: Replace the three occurrences of SublimeTextPortable in this file
...
user in an INI file next to SublimeTextPortable.exe called SublimeTextPortable.ini.
...
copy AppNamePortable.ini from this directory to SublimeTextPortable.ini next to
SublimeTextPortable.exe. The options in the INI file are as follows:
